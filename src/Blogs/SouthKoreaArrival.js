...
const CurrentBlog = () =>{
    ...
    <div className = "BlogPage-Content">    
        ...
        <p className = "Blogpage-Paragraph">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Commodo elit at imperdiet dui accumsan. Convallis posuere morbi leo urna molestie at elementum eu facilisis. Et malesuada fames ac turpis egestas integer eget.
            <br/>
            <br/>
            Gravida in fermentum et sollicitudin ac orci phasellus egestas tellus. Accumsan sit amet nulla facilisi morbi tempus iaculis urna. Nibh praesent tristique magna sit amet purus. Sapien eget mi proin sed libero enim sed faucibus turpis. Nunc faucibus a pellentesque sit amet porttitor eget. Id porta nibh venenatis cras sed. Dui sapien eget mi proin sed libero. Magna fermentum iaculis eu non. Vitae tempus quam pellentesque nec nam aliquam. Neque volutpat ac tincidunt vitae semper quis lectus. A arcu cursus vitae congue.
            Non consectetur a erat nam at lectus urna duis convallis.
        </p>

        <div className = "Blogpage-image-container-content">
            <img src = {blog_image_2} alt = "Me in japan"/>
        </div>
